...
const config = {
  title: "Manage Completed Projects",
  endpoint: "/projects",
  columns: [
  ...
  fields: [
    ...
    { name: "location", label: "Location", kind: "text" },
    {
      ...
      label: "Work Category",
      kind: "text",
      placeholder: "Radiography by Using X-Ray Crawler & Gamma Ray",
    },
    ...
    },
    {
      ...
      kind: "text",
      placeholder: "Engr. Name, Designation, Company",
    },
